  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col p-4">
        ...
        {/* Buy Now Button */}
        <button className="flex items-center justify-center gap-2 text-white px-4 py-2 rounded-lg bg-gradient-to-r from-[#c9812f] to-blue-500 cursor-pointer font-semibold">
